...
srv:listen(80,function(conn)
    conn:on("receive", function(client,request)
        ...
        buf = buf.. "<html>";
        buf = buf.. "<body style='background: #00979C'>";

        buf = buf.. "<title>Moduł bezprzewodowy</title>";
        buf = buf.. "<h1>Praca magisterska v1.3</h1>";
        buf = buf.. "<p align='center'>LED <a href=\"?pin=ON1\"><button>ON</button></a>&nbsp;<a href=\"?pin=OFF1\"><button>OFF</button></a></p>";
